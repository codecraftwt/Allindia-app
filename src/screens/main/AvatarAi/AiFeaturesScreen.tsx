...
const styles = StyleSheet.create({
  ...
  snippetContainer: { marginBottom: moderateScale(6) },
  cardFooter: {
    borderTopWidth: 1,
  ...
  resumeHeader: { width: '40%', height: moderateScale(6), borderRadius: radius.xs, marginBottom: 8 },
  resumeLine: { width: '100%', height: moderateScale(4), borderRadius: radius.xs, marginBottom: 4 },
  resumeLineShort: { width: '70%', height: moderateScale(4), borderRadius: radius.xs },
  badgeUi: {
    position: 'absolute',
  ...
  badgeUiText: { fontSize: moderateScale(8.5), fontWeight: 'bold', marginLeft: 4 },
  chatSnippet: { borderRadius: radius.md, padding: moderateScale(8) },
  chatBubble: {
  ...
  chatBubbleText: { fontSize: moderateScale(11), fontStyle: 'italic' },
  waveformContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  waveBar: { width: moderateScale(3), borderRadius: radius.xs },
  skillSnippet: { borderRadius: radius.md, padding: moderateScale(10), borderWidth: 1 },
  skillRow: { marginBottom: moderateScale(6) },
  skillLabel: { fontSize: moderateScale(10), marginBottom: 3, fontWeight: '600' },
  progressBarBg: { height: moderateScale(5), borderRadius: radius.xs, overflow: 'hidden' },
  ...
  audioWaveLine: { flex: 1, height: 1, marginHorizontal: moderateScale(10) },
  audioDot: { width: moderateScale(8), height: moderateScale(8), borderRadius: moderateScale(4) },
});
