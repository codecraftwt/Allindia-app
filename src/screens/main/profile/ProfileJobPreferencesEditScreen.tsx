...
const styles = StyleSheet.create({
  ...
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(8), marginBottom: moderateScale(8) },
  sectionDot: { width: moderateScale(6), height: moderateScale(6), borderRadius: moderateScale(3) },
  ...
  accordion: { borderRadius: radius.md, borderWidth: 1, padding: moderateScale(12), overflow: 'hidden' },
  accordionHeader: { flexDirection: 'row', alignItems: 'center' },
  subCatGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: moderateScale(8), marginTop: moderateScale(spacing.sm) },
  subCatItem: { paddingHorizontal: moderateScale(12), paddingVertical: moderateScale(8), borderRadius: radius.sm, borderWidth: 1 },
  chipWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: moderateScale(8) },
  chip: { paddingHorizontal: moderateScale(16), paddingVertical: moderateScale(10), borderRadius: radius.pill, borderWidth: 1 },
  sliderThumb: {
    position: 'absolute',
  ...
  toggleRow: { flexDirection: 'row', alignItems: 'center', padding: moderateScale(14), borderRadius: radius.md, borderWidth: 1, marginTop: 4 },
  segmentRow: { flexDirection: 'row', gap: moderateScale(12), marginTop: 4 },
